  ...
  return (
    <div style={{ padding: "2rem", fontFamily: "Arial, sans-serif" }}>
      <div style={{ textAlign: "center", marginBottom: "2rem" }}>
        ...
        <h2 className="text-2xl font-bold mb-2">SignalSync by Contentive Media</h2>
        ...
        <a
          href="/login"
          className="inline-block mt-4 px-6 py-3 bg-blue-600 text-white text-lg rounded-xl hover:bg-blue-700 transition"
        >
          🔐 Explore SignalSync
        </a>
      </div>
